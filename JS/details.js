const data = {
    ...
    function displayEventDetails() {
      ...
      const eventData = data.events.find(event => event._id === eventId);
...
if (eventData) {
  ...
  document.getElementById('event-place').textContent = eventData.place;
  document.getElementById('event-capacity').textContent = eventData.capacity;
  document.getElementById('event-price').textContent = eventData.price;
    ...
    // Call the function to display the event details
    displayEventDetails();